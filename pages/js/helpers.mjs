...
var time_ago = (function (date) {
const now1 = new Date();
const diff_ms2 = (now1.getTime()) - (date.getTime());
const seconds3 = Math.floor.call(null, (diff_ms2) / (1000));
const minutes4 = Math.floor.call(null, (seconds3) / (60));
const hours5 = Math.floor.call(null, (minutes4) / (60));
const days6 = Math.floor.call(null, (hours5) / (24));
const weeks7 = Math.floor.call(null, (days6) / (7));
const months8 = Math.floor.call(null, (days6) / (30.44));
const years9 = Math.floor.call(null, (days6) / (365.25));
if ((seconds3) < (60)) {
return "just now";} else {
if ((minutes4) < (60)) {
return cherry_core.str.call(null, minutes4, " ", (cherry_core.truth_.call(null, cherry_core._EQ_.call(null, minutes4, 1))) ? ("minute") : ("minutes"), " ago");} else {
if ((hours5) < (24)) {
return cherry_core.str.call(null, hours5, " ", (cherry_core.truth_.call(null, cherry_core._EQ_.call(null, hours5, 1))) ? ("hour") : ("hours"), " ago");} else {
if ((days6) < (7)) {
return cherry_core.str.call(null, days6, " ", (cherry_core.truth_.call(null, cherry_core._EQ_.call(null, days6, 1))) ? ("day") : ("days"), " ago");} else {
if ((weeks7) < (5)) {
return cherry_core.str.call(null, weeks7, " ", (cherry_core.truth_.call(null, cherry_core._EQ_.call(null, weeks7, 1))) ? ("week") : ("weeks"), " ago");} else {
if ((months8) < (12)) {
return cherry_core.str.call(null, months8, " ", (cherry_core.truth_.call(null, cherry_core._EQ_.call(null, months8, 1))) ? ("month") : ("months"), " ago");} else {
if (cherry_core.truth_.call(null, cherry_core.keyword("else"))) {
return cherry_core.str.call(null, years9, " ", (cherry_core.truth_.call(null, cherry_core._EQ_.call(null, years9, 1))) ? ("year") : ("years"), " ago");} else {
return null;}}}}}}}
});

export { css_var, no_self_referring_link, set_attrs, time_ago, get_BANG_, set_children, set_content, set_inner_html, hiccup_to_node }
